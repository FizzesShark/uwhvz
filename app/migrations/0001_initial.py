# Generated by Django 3.2.12 on 2022-02-17 01:45
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    enumfields.fields.EnumField(
                        enum=app.models.player.PlayerRole, max_length=1
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    enumfields.fields.EnumField(
                        default="S", enum=app.models.tag.TagType, max_length=1
                    ),
                ),
                ("active", models.BooleanField(default=True)),
                ("point_modifier", models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    enumfields.fields.EnumField(
                        blank=True,
                        enum=app.models.participant.ParticipantRole,
                        max_length=1,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "modifier_type",
                    enumfields.fields.EnumField(
                        enum=app.models.modifier.ModifierType, max_length=1
                    ),
                ),
                ...
                (
                    "faction",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="app.faction"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=180,
                        null=True,
                        verbose_name="Moderator 'score'. Can include letters.",
                    ),
                ),
                (
                    "game",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="app.game"
            ),
        ),
        migrations.CreateModel(
            name="Email",
            fields=[
                ...
                (
                    "group",
                    enumfields.fields.EnumField(
                        enum=app.models.email.RecipientGroup, max_length=1
                    ),
                ),
