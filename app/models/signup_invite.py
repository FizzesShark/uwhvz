...
class SignupInvite(models.Model):
    ...
    signup_location: SignupLocation = models.ForeignKey(
        SignupLocation, on_delete=models.CASCADE
    )
    email: str = models.EmailField()
    participant_role: Enum = EnumField(
        enum=ParticipantRole, max_length=1, blank=True, null=True
    )
