...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        zombie = User.objects.create_user(
            "zombie@email.com", "password", first_name="Zombie", last_name="Player"
        )
        human = User.objects.create_user(
            "human@email.com", "password", first_name="Human", last_name="Player"
        )
        spectator = User.objects.create_user(
            "spectator@email.com", "password", first_name="A", last_name="Spectator"
        )
